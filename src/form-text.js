...
export default function FormText(){
    ...
    return(
        <div className="mt-4 mx-auto p-3 round" style={{width:'400px', backgroundColor:'#cee'}}>
            <form>
                ...
                <div className="form-group mb-2">
                    ...
                    <input type="password" id="pswd2" name="pswd2" className="form-control form-control-sm" ref={textPswd2} onBlur={onBlurPassword2}/>
                </div>
